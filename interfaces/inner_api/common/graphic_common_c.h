...
enum GSError {
    ...
    // 300 NATIVE BUFFER
    GSERROR_MEM_OPERATION_ERROR   = 30001000,
    ...
    GSERROR_NO_BUFFER_READY       = 40605000,
    ...
    GSERROR_CONSUMER_IS_CONNECTED = 41206000,
    GSERROR_BUFFER_STATE_INVALID  = 41207000,
    ...
    GSERROR_CONSUMER_UNREGISTER_LISTENER = 41212000,
    ...
    // EGL ERROR
    GSERROR_EGL_STATE_UNKOWN      = 60001000,
    GSERROR_EGL_API_FAILED        = 60002000,
    ...
    SURFACE_ERROR_UNKOWN = GSERROR_INTERNAL,
    SURFACE_ERROR_EGL_STATE_UNKONW = GSERROR_EGL_STATE_UNKOWN,
    SURFACE_ERROR_EGL_API_FAILED = GSERROR_EGL_API_FAILED,
    SURFACE_ERROR_CONSUMER_IS_CONNECTED = GSERROR_CONSUMER_IS_CONNECTED,
    SURFACE_ERROR_BUFFER_STATE_INVALID = GSERROR_BUFFER_STATE_INVALID,
    SURFACE_ERROR_BUFFER_IS_INCACHE = GSERROR_BUFFER_IS_INCACHE,
    SURFACE_ERROR_BUFFER_QUEUE_FULL = GSERROR_BUFFER_QUEUE_FULL,
    SURFACE_ERROR_BUFFER_NOT_INCACHE = GSERROR_BUFFER_NOT_INCACHE,
    SURFACE_ERROR_CONSUMER_DISCONNECTED = GSERROR_CONSUMER_DISCONNECTED,
    SURFACE_ERROR_CONSUMER_UNREGISTER_LISTENER = GSERROR_CONSUMER_UNREGISTER_LISTENER,
    SURFACE_ERROR_MEM_OPERATION_ERROR = GSERROR_MEM_OPERATION_ERROR,
    ...
    VSYNC_ERROR_NOT_SUPPORT = GSERROR_NOT_SUPPORT,
    VSYNC_ERROR_NOT_INIT = GSERROR_NOT_INIT,
    VSYNC_ERROR_UNKOWN = GSERROR_INTERNAL,

    COMPOSITOR_ERROR_OK = GSERROR_OK,
    COMPOSITOR_ERROR_API_FAILED = GSERROR_API_FAILED,
    COMPOSITOR_ERROR_INVALID_OPERATING = GSERROR_INVALID_OPERATING,
    COMPOSITOR_ERROR_NULLPTR = GSERROR_INVALID_ARGUMENTS,
    COMPOSITOR_ERROR_BINDER_ERROR = GSERROR_BINDER,
    COMPOSITOR_ERROR_SAMGR = GSERROR_CONNOT_CONNECT_SAMGR,
    COMPOSITOR_ERROR_SERVICE_NOT_FOUND = GSERROR_SERVER_ERROR,
    COMPOSITOR_ERROR_PROXY_NOT_INCLUDE = GSERROR_PROXY_NOT_INCLUDE,
    COMPOSITOR_ERROR_INNER = GSERROR_INTERNAL,
    COMPOSITOR_ERROR_INVALID_ARGUMENTS = GSERROR_INVALID_ARGUMENTS,
    COMPOSITOR_ERROR_NOT_SUPPORT = GSERROR_NOT_SUPPORT,
    COMPOSITOR_ERROR_NOT_INIT = GSERROR_NOT_INIT,
    COMPOSITOR_ERROR_UNKOWN = GSERROR_INTERNAL,
};
