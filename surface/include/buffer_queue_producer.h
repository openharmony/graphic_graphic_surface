...
private:
    ...
    int32_t RegisterReleaseListenerBackupRemote(MessageParcel &arguments, MessageParcel &reply,
                                                   MessageOption &option);
    int32_t UnRegisterReleaseListenerRemote(MessageParcel &arguments, MessageParcel &reply, MessageOption &option);
    int32_t UnRegisterReleaseListenerBackupRemote(MessageParcel &arguments, MessageParcel &reply,
                                                     MessageOption &option);
    ...
    int32_t GetFrameGravityRemote(MessageParcel &arguments, MessageParcel &reply, MessageOption &option);
    int32_t SetFrameGravityRemote(MessageParcel &arguments, MessageParcel &reply, MessageOption &option);
    int32_t GetFixedRotationRemote(MessageParcel &arguments, MessageParcel &reply, MessageOption &option);
