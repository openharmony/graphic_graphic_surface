...
using CM_ColorSpaceType_V2_1 = HDI::Display::Graphic::Common::V2_1::CM_ColorSpaceType;
...
static std::unordered_map<OH_NativeBuffer_ColorSpace, CM_ColorSpaceType_V2_1> NATIVE_COLORSPACE_TO_HDI_MAP = {
    {OH_COLORSPACE_NONE, CM_ColorSpaceType_V2_1::CM_COLORSPACE_NONE},
    {OH_COLORSPACE_BT601_EBU_FULL, CM_ColorSpaceType_V2_1::CM_BT601_EBU_FULL},
    {OH_COLORSPACE_BT601_SMPTE_C_FULL, CM_ColorSpaceType_V2_1::CM_BT601_SMPTE_C_FULL},
    {OH_COLORSPACE_BT709_FULL, CM_ColorSpaceType_V2_1::CM_BT709_FULL},
    {OH_COLORSPACE_BT2020_HLG_FULL, CM_ColorSpaceType_V2_1::CM_BT2020_HLG_FULL},
    {OH_COLORSPACE_BT2020_PQ_FULL, CM_ColorSpaceType_V2_1::CM_BT2020_PQ_FULL},
    {OH_COLORSPACE_BT601_EBU_LIMIT, CM_ColorSpaceType_V2_1::CM_BT601_EBU_LIMIT},
    {OH_COLORSPACE_BT601_SMPTE_C_LIMIT, CM_ColorSpaceType_V2_1::CM_BT601_SMPTE_C_LIMIT},
    {OH_COLORSPACE_BT709_LIMIT, CM_ColorSpaceType_V2_1::CM_BT709_LIMIT},
    {OH_COLORSPACE_BT2020_HLG_LIMIT, CM_ColorSpaceType_V2_1::CM_BT2020_HLG_LIMIT},
    {OH_COLORSPACE_BT2020_PQ_LIMIT, CM_ColorSpaceType_V2_1::CM_BT2020_PQ_LIMIT},
    {OH_COLORSPACE_SRGB_FULL, CM_ColorSpaceType_V2_1::CM_SRGB_FULL},
    {OH_COLORSPACE_P3_FULL, CM_ColorSpaceType_V2_1::CM_P3_FULL},
    {OH_COLORSPACE_P3_HLG_FULL, CM_ColorSpaceType_V2_1::CM_P3_HLG_FULL},
    {OH_COLORSPACE_P3_PQ_FULL, CM_ColorSpaceType_V2_1::CM_P3_PQ_FULL},
    {OH_COLORSPACE_ADOBERGB_FULL, CM_ColorSpaceType_V2_1::CM_ADOBERGB_FULL},
    {OH_COLORSPACE_SRGB_LIMIT, CM_ColorSpaceType_V2_1::CM_SRGB_LIMIT},
    {OH_COLORSPACE_P3_LIMIT, CM_ColorSpaceType_V2_1::CM_P3_LIMIT},
    {OH_COLORSPACE_P3_HLG_LIMIT, CM_ColorSpaceType_V2_1::CM_P3_HLG_LIMIT},
    {OH_COLORSPACE_P3_PQ_LIMIT, CM_ColorSpaceType_V2_1::CM_P3_PQ_LIMIT},
    {OH_COLORSPACE_ADOBERGB_LIMIT, CM_ColorSpaceType_V2_1::CM_ADOBERGB_LIMIT},
    {OH_COLORSPACE_LINEAR_SRGB, CM_ColorSpaceType_V2_1::CM_LINEAR_SRGB},
    {OH_COLORSPACE_LINEAR_BT709, CM_ColorSpaceType_V2_1::CM_LINEAR_BT709},
    {OH_COLORSPACE_LINEAR_P3, CM_ColorSpaceType_V2_1::CM_LINEAR_P3},
    {OH_COLORSPACE_LINEAR_BT2020, CM_ColorSpaceType_V2_1::CM_LINEAR_BT2020},
    {OH_COLORSPACE_DISPLAY_SRGB, CM_ColorSpaceType_V2_1::CM_DISPLAY_SRGB},
    {OH_COLORSPACE_DISPLAY_P3_SRGB, CM_ColorSpaceType_V2_1::CM_DISPLAY_P3_SRGB},
    {OH_COLORSPACE_DISPLAY_P3_HLG, CM_ColorSpaceType_V2_1::CM_DISPLAY_P3_HLG},
    {OH_COLORSPACE_DISPLAY_P3_PQ, CM_ColorSpaceType_V2_1::CM_DISPLAY_P3_PQ},
    {OH_COLORSPACE_DISPLAY_BT2020_SRGB, CM_ColorSpaceType_V2_1::CM_DISPLAY_BT2020_SRGB},
    {OH_COLORSPACE_DISPLAY_BT2020_HLG, CM_ColorSpaceType_V2_1::CM_DISPLAY_BT2020_HLG},
    {OH_COLORSPACE_DISPLAY_BT2020_PQ, CM_ColorSpaceType_V2_1::CM_DISPLAY_BT2020_PQ},
    {OH_COLORSPACE_BT2020_LOG_FULL, CM_ColorSpaceType_V2_1::CM_BT2020_LOG_FULL},
    {OH_COLORSPACE_BT2020_LOG_LIMIT, CM_ColorSpaceType_V2_1::CM_BT2020_LOG_LIMIT},
};
...
bool IsNativeObjectAvailable(void *obj)
{
    int32_t magicNum = GetNativeObjectMagic(obj);
    if (magicNum != NATIVE_OBJECT_MAGIC_WINDOW && magicNum != NATIVE_OBJECT_MAGIC_WINDOW_BUFFER) {
        BLOGE("NativeObject Invalid magic illegal: %{public}d", magicNum);
        return false;
    }
...
{
    if (window == nullptr || buffer == nullptr || fenceFd == nullptr || !IsNativeObjectAvailable(window)) {
    ...
    int fenceFd, struct Region region)
{
    ...
    if (window == nullptr || buffer == nullptr || window->surface == nullptr || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
...
{
    if (window == nullptr || buffer == nullptr || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
...
{
    if (buffer == nullptr || buffer->sfbuffer == nullptr || !IsNativeObjectAvailable(buffer)) {
        return nullptr;
    }
                                   ...
                                   int32_t size, const uint8_t *metaData)
{
    if (window == nullptr || window->surface == nullptr ||
        ...
        size <= 0 || size > META_DATA_MAX_SIZE || metaData == nullptr || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
...
{
    if (window == nullptr || window->surface == nullptr || handle == nullptr || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
...
{
    if (window == nullptr || window->surface == nullptr || surfaceId == nullptr || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
...
{
    if (window == nullptr || window->surface == nullptr || transform == nullptr || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
...
int32_t OH_NativeWindow_SetColorSpace(OHNativeWindow *window, OH_NativeBuffer_ColorSpace colorSpace)
{
    ...
    if (window == nullptr || iter == NATIVE_COLORSPACE_TO_HDI_MAP.end() || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
...
int32_t ConvertColorSpaceTypeToNativeBufferColorSpace(int32_t colorSpaceType, OH_NativeBuffer_ColorSpace* colorSpace)
{
    ...
    auto it = std::find_if(NATIVE_COLORSPACE_TO_HDI_MAP.begin(), NATIVE_COLORSPACE_TO_HDI_MAP.end(),
            [colorSpaceEnumType](const std::pair<OH_NativeBuffer_ColorSpace, CM_ColorSpaceType_V2_1>& element) {
                return element.second == static_cast<CM_ColorSpaceType_V2_1>(colorSpaceEnumType);
            });
    if (it != NATIVE_COLORSPACE_TO_HDI_MAP.end()) {
        *colorSpace = it->first;
        return OHOS::SURFACE_ERROR_OK;
    }
    BLOGD("the colorSpace: %{public}d does not support it.", colorSpaceType);
    return OHOS::SURFACE_ERROR_UNKOWN;
}

int32_t NativeWindowPreAllocBuffers(OHNativeWindow *window, uint32_t allocBufferCnt)
{
    if (window == nullptr || allocBufferCnt == 0 || !IsNativeObjectAvailable(window)) {
        return OHOS::SURFACE_ERROR_INVALID_PARAM;
    }
    BLOGE_CHECK_AND_RETURN_RET(window->surface != nullptr, SURFACE_ERROR_ERROR, "window surface is null.");
